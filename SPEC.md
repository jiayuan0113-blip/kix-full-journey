...
- 首屏：角标（给街边小店—咖啡/奶茶/小吃 & more）+ 标题「把路过的人，变成回头客」+ 副标题（客人玩游戏赢券，凭券进店。**老客太久没来，自动召回。**）+ 双 CTA（免费创建第一个游戏 / 看怎么玩）+ 真实战绩三数（48% 到店率 · 1,500 新客到店 · 29% 老客召回复购）+ 右侧**可玩转盘**（手机内，自动转一次）。
- 闭环带：扫码玩 → 赢券 → 到店核销（二维码/滑动）→ 老客自动召回。
- 其余区：一套搞定三件事（拉新/复购/看清账）/ 游戏样片（8 个，1000+ 模板）/ 三步上线 / 价格（免费 S$0 · 专业 S$49 · 连锁 联系我们）/ 结尾绿色 CTA / 页脚。
- 所有 CTA → 建游戏（未登录）。
...
**进度推动（非模态）**：✓ 游戏已上线 → 分享游戏·打印二维码 → 第一位客人到店核销。帮商家在首次上手时知道「下一步做什么」。
