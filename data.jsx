...
const DEFAULT_ACTIVITIES = [
  ...
  { id:"a2", name:{en:"Mid-Autumn Mooncake",zh:"中秋月饼礼"},
    outletIds:["o1"],
    vouchers: [ {...DEFAULT_VOUCHERS[0], name:{en:"Free mooncake",zh:"月饼一份"}, qty:60, awarded:0, redeemed:0} ],
    gameId:"scratch", status:"draft" },
  { id:"a3", name:{en:"New Drink Launch",zh:"新品上市试饮"},
    outletIds:["o2"],
    vouchers: [ {...DEFAULT_VOUCHERS[0], name:{en:"$2 off new drink",zh:"新品减 2 元"}, qty:100, awarded:92, redeemed:70} ],
